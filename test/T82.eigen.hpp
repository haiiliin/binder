/// @file   binder/test/T82.eigen.hpp
/// @brief  Binder test file for Eigen library
/// @author Hailin Wang

#ifndef BINDER_T82_EIGEN_HPP
#define BINDER_T82_EIGEN_HPP
...
template Eigen::Matrix<double, 3, 3> foo_eigen_argument_and_return_function<double>(const Eigen::Matrix<double, 3, 3> &);
...
public:
	...
	static Eigen::Matrix<T, 3, 3> foo_eigen_argument_and_return_method_static(const Eigen::Matrix<T, 3, 3> &m) { return m; }
};
