...
cl::opt<bool> O_include_nanobind_stl("include-nanobind-stl", cl::desc("When specified bindings for STL classes in <pybind11/stl/*.h> will be used instead of generating custom STL bindings."),
					 cl::init(false), cl::cat(BinderToolCategory));
